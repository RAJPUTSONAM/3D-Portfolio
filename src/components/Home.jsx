  ...
  return (
    <section className="relative w-full h-screen mx-auto fixed ">
      <div className={`${styles.paddingX} absolute inset-0 top-[20px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
       ...
       <span className="block text-indigo-600 text-3xl sm:text-lg lg:text-4xl mt-2">
  Turning <span className="pl-1">Visions</span> into Code
</span>

    </h4>
         <p className="text-slate-400 text-sm sm:text-base lg:text-lg max-w-2xl mt-[1px] md:mt-32 lg:mt-3 leading-[26px] sm:leading-[28px] lg:leading-[30px] p-[1px] md:p-0">
